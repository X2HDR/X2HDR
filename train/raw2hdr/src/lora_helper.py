...
def update_model_with_lora(checkpoint, lora_weights, transformer, cond_width, cond_height):
...
def update_model_with_multi_lora(checkpoints, lora_weights, transformer, cond_width, cond_height):
