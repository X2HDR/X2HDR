...
from src.jsonl_datasets import make_raw2hdr_train_dataset, collate_fn
from src.hdr_utils import read_hdr_image
...
def parse_args(input_args=None):
    ...
    parser.add_argument("--cond_width", type=int, default=512, help="width of the condition data.")
    parser.add_argument("--cond_height", type=int, default=512, help="height of the condition data.")
    ...
    parser.add_argument("--input_is_raw", action="store_true", help="whether the input is raw.")
    parser.add_argument(
        "--train_data_dir",
        type=str,
        default="",
...
def main(args):
        ...
        for name, attn_processor in transformer.attn_processors.items():
            ...
            if name.startswith("transformer_blocks") and layer_index in double_blocks_idx:
                ...
                lora_attn_procs[name] = MultiDoubleStreamBlockLoraProcessor(
                    dim=3072, ranks=args.ranks, network_alphas=args.network_alphas, lora_weights=[1 for _ in range(args.lora_num)], device=accelerator.device, dtype=weight_dtype, cond_width=args.cond_width, cond_height=args.cond_height, n_loras=args.lora_num
                )
    ...
    train_dataset = make_raw2hdr_train_dataset(args, tokenizers, accelerator)
    ...
    vae_scale_factor = 16
    height_cond = 2 * (args.cond_height // vae_scale_factor)
    width_cond = 2 * (args.cond_width // vae_scale_factor)        
    offset = 64
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(models_to_accumulate):
                ...
                if args.subject_column is not None:
                    ...
                    sub_number = subject_pixel_values.shape[-2] // args.cond_height
                ...
                if args.spatial_column is not None:
                    ...
                    cond_number = cond_pixel_values.shape[-2] // args.cond_height
            ...
            if accelerator.sync_gradients:
                ...
                if accelerator.is_main_process:
                    ...
                    if args.validation_prompt is not None and global_step % args.validation_steps == 0:
                        ...
                        if len(args.spatial_test_images) != 0 and args.spatial_test_images != ['None']:
                            ...
                            if args.input_is_raw:
                                spatial_ls = [read_hdr_image(image_path) for image_path in spatial_paths]
                            else:
                        ...
                        pipeline_args = {"prompt": args.validation_prompt,
                                         ...
                                         "cond_height": args.cond_height,
                                         "guidance_scale": 3,
                                         "num_inference_steps": 20,
                                         "max_sequence_length": 512,
                                         "input_is_raw": args.input_is_raw,
                                         }
                ...
                logs = {"loss": avg_loss.item(), "lr": lr_scheduler.get_last_lr()[0]}
