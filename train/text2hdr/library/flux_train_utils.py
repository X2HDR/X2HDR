...
from library.hdr_utils import save_hdr_image, pu21_decode_rgb
...
def sample_image_inference(
    ...
    logger.info(f"controlnet_image: {controlnet_image}")
    if cfg_scale != 1.0:
    ...
    image = Image.fromarray((127.5 * (x_numpy + 1.0)).astype(np.uint8))
