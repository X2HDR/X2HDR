...
class NetworkTrainer:
    ...
    def sample_images(self, accelerator, args, epoch, global_step, device, vae, tokenizers, text_encoder, unet, hdr_mode=False):
        train_util.sample_images(accelerator, args, epoch, global_step, device, vae, tokenizers[0], text_encoder, unet, hdr_mode=hdr_mode)
    ...
    def train(self, args):
        ...
        train_util.init_trackers(accelerator, args, "hdr_lora")
        ...
        # For --sample_at_first
        optimizer_eval_fn()
        self.sample_images(accelerator, args, 0, global_step, accelerator.device, vae, tokenizers, text_encoder, unet, hdr_mode=args.hdr_mode)
        optimizer_train_fn()
        ...
        for epoch in range(epoch_to_start, num_train_epochs):
            ...
            for step, batch in enumerate(skipped_dataloader or train_dataloader):
                ...
                if accelerator.sync_gradients:
                    ...
                    optimizer_eval_fn()
                    self.sample_images(
                        accelerator, args, None, global_step, accelerator.device, vae, tokenizers, text_encoder, unet, hdr_mode=args.hdr_mode
                    )
            ...
            self.sample_images(accelerator, args, epoch + 1, global_step, accelerator.device, vae, tokenizers, text_encoder, unet, hdr_mode=args.hdr_mode)
            progress_bar.unpause()
            optimizer_train_fn()
